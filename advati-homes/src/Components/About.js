    ...
    <div>
        ...
        <div className="about-main">
                ...
                <div className="about-right">
                        <h4>ABOUT US <hr /> </h4>
                        <h1>How much is your <span>property worth now?</span> </h1>
                        ...
                        <div className="about-points">
                            ...
                            <h3><span></span>Care &Comfort </h3>
                            <h3><span></span>Step into One-of-a-kind </h3>
                            <h3><span></span>Now It's Our Turn To Take Care Of You</h3>
                            </div>
                            <div className="point-right">
                            <h3><span></span>All Along You Took Care Ofe Others.  </h3>
                            <h3><span></span>Relax and Rejuvenate </h3>
                            </div>
                        </div>
                        <div className="quote-btn  cursor-pointer">
              <a href="">Know More<img src={arrow} alt="" /> </a>
            </div>
